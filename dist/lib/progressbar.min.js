    ...
    1: [function (b, c, d) {
      (function () {
        var b = this || Function("return this")(),
          ...
          function m(a, b) {
            var c = {},
                d = typeof b === "undefined" ? "undefined" : _typeof(b);
          ...
          }), "function" == typeof SHIFTY_DEBUG_NOW && (b.timeoutHandler = l), "object" == (typeof d === "undefined" ? "undefined" : _typeof(d)) ? c.exports = n : "function" == typeof a && a.amd ? a(function () {
            return n;
        ...
        !function () {
          ...
          function i(a, b, c) {
            var d = b.match(a),
                e = b.replace(a, A);
            if (d) for (var f, g = d.length, h = 0; g > h; h++) {
          ...
          function t(b, c) {
            a.each(c, function (a) {
              var d = c[a],
                  ...
                  f = e.length,
                  g = b[e[0]],
                  h = typeof g === "undefined" ? "undefined" : _typeof(g);
              if ("string" === h) {
                for (var i = "", j = 0; f > j; j++) {
